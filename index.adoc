...
:docinfo:
:sectids!:
:stake: https://github.com/graphitefriction/decks/stakeholder-questions.adoc
:oscon2013: http://mojavelinux.github.io/decks/docs-workshop/oscon2013/index.html
...
OSCON 2013::
  ...
  * {oscon2013}[Easier Documentation, Simpler Websites and Faster Collaboration (slideshow)]
